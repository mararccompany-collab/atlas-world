...
export const extraDetailsData: Record<string, Partial<Country>> = {
  ...
  eg: {
    landmarkDetails: [
      { name: "Pyramids of Giza", nameAr: "أهرامات الجيزة", type: "أثر فرعوني", description: "أهرامات خوفو وخفرع ومنقرع، واحدة من عجائب الدنيا السبع القديمة وبناها الفرعون خوفو حوالي 2560 ق.م." },
      { name: "Great Sphinx", nameAr: "أبو الهول", type: "تمثال", description: "تمثال أسطوري برأس إنسان وجسد أسد، يقع بجوار أهرامات الجيزة، يبلغ طوله 73 متراً وارتفاعه 20 متراً." },
      { name: "Karnak Temple", nameAr: "معبد الكرنك", type: "معبد فرعوني", description: "مجمع معابد ضخم في الأقصر، أكبر موقع ديني قديم في العالم. بُني على مدى 2,000 عام من عصر الدولة الوسطى حتى العصر البطلمي." },
      { name: "Valley of the Kings", nameAr: "وادي الملوك", type: "مقبرة فرعونية", description: "وادي في الأقصر ضم مقابر ملوك الفراعنة من عصر الدولة الحديثة، أشهرها مقبرة توت عنخ آمون." },
      { name: "Abu Simbel", nameAr: "معبد أبو سمبل", type: "معبد فرعوني", description: "معبد رمسيس الثاني في أسوان، نُقل بالكامل في الستينيات لإنقاذه من الغمر بعد بناء السد العالي." },
      { name: "Philae Temple", nameAr: "معبد فيلة", type: "معبد فرعوني", description: "معبد الإيزيس في جزيرة فيلة بأسوان، نُقل إلى جزيرة أجيليكا بعد بناء السد العالي." },
      { name: "Hatshepsut Temple", nameAr: "معبد حتشبسوت", type: "معبد فرعوني", description: "معبد الملكة حتشبسوت في الدير البحري بالأقصر، تحفة معمارية فريدة منحوتة في الجبل." },
      { name: "Egyptian Museum", nameAr: "المتحف المصري", type: "متحف", description: "يضم أكبر مجموعة من الآثار الفرعونية في العالم، بما في ذلك كنوز توت عنخ آمون في ميدان التحرير." },
      { name: "Grand Egyptian Museum", nameAr: "المتحف المصري الكبير", type: "متحف", description: "أكبر متحف في العالم مخصص لحضارة واحدة، يقع بالقرب من أهرامات الجيزة." },
      { name: "Citadel of Saladin", nameAr: "قلعة صلاح الدين", type: "قلعة إسلامية", description: "قلعة من العصر الأيوبي بناها صلاح الدين الأيوبي في القاهرة لحماية المدينة من الصليبيين." },
      { name: "Mohamed Ali Mosque", nameAr: "مسجد محمد علي", type: "مسجد", description: "مسجد من العصر العثماني يقع ضمن قلعة صلاح الدين، يتميز بمآذنه الطويلة وقبته الضخمة." },
      { name: "Al-Azhar Mosque", nameAr: "الجامع الأزهر", type: "مسجد", description: "من أقدم المساجد في القاهرة، بُني عام 970م على يد الفاطميين، ويمثل مركزاً دينياً وعلمياً رئيسياً." },
      { name: "Saint Catherine Monastery", nameAr: "دير سانت كاترين", type: "دير", description: "أقدم دير مسيحي في العالم لا يزال قيد الاستخدام، يقع في جنوب سيناء عند سفح جبل موسى." },
      { name: "Bibliotheca Alexandrina", nameAr: "مكتبة الإسكندرية", type: "مكتبة", description: "مكتبة ضخمة في الإسكندرية، تمثل إعادة إحياء لمكتبة الإسكندرية القديمة، تتسع لـ 8 ملايين كتاب." },
      { name: "Khan El Khalili", nameAr: "خان الخليلي", type: "سوق تاريخي", description: "أشهر أسواق القاهرة القديمة، يعود تاريخه إلى العصر المملوكي، مقصد للسياح ورواد القاهرة." },
      { name: "Al-Muizz Street", nameAr: "شارع المعز لدين الله", type: "شارع تاريخي", description: "أطول شارع أثري في العالم، يضم آثاراً من العصور الفاطمية والأيوبية والمملوكية والعثمانية." },
    ],
    riverDetails: [
      { name: "Nile River", nameAr: "نهر النيل", length: "6,650 كم", description: "أطول نهر في العالم، ينبع من بحيرة فيكتوريا في أوغندا ويجري عبر 11 دولة قبل أن يصب في البحر الأبيض المتوسط. شريان الحياة لمصر منذ آلاف السنين." },
    ],
    lakeDetails: [
      { name: "Lake Nasser", nameAr: "بحيرة ناصر", area: "5,250 كم²", description: "بحيرة اصطناعية ضخمة خلف السد العالي في أسوان، ثاني أكبر بحيرة اصطناعية في العالم بعد بحيرة فولتا. تخزن مياه النيل لتوليد الكهرباء والري." },
      { name: "Lake Manzala", nameAr: "بحيرة المنزلة", area: "1,360 كم²", description: "أكبر بحيرات الدلتا الشمالية، تقع شرق الدلتا بين دمياط وبورسعيد." },
      { name: "Lake Burullus", nameAr: "بحيرة البرلس", area: "460 كم²", description: "بحيرة ساحلية شمالية في محافظة كفر الشيخ، محمية طبيعية للطيور المهاجرة." },
      { name: "Lake Qarun", nameAr: "بحيرة قارون", area: "230 كم²", description: "بحيرة طبيعية في الفيوم من العصر الجليدي، أقدم بحيرة طبيعية في العالم." },
      { name: "Lake Mariout", nameAr: "بحيرة مريوط", area: "250 كم²", description: "بحيرة ساحلية جنوب الإسكندرية، تفصل المدينة عن الصحراء." },
      { name: "Lake Bardawil", nameAr: "بحيرة البردويل", area: "700 كم²", description: "بحيرة مالحة ساحلية في شمال سيناء، محمية طبيعية هامة للطيور." },
    ],
    borderingSeas: ['البحر الأبيض المتوسط (1,050 كم ساحل)', 'البحر الأحمر (1,100 كم ساحل)', 'قناة السويس (193 كم)'],
    celebrities: [
      { name: "Mohamed Salah", nameAr: "محمد صلاح", profession: "لاعب كرة قدم", knownFor: "نجم نادي ليفربول ومنتخب مصر، هداف الدوري الإنجليزي، أفضل لاعب في أفريقيا 2017 و2018." },
      { name: "Amr Diab", nameAr: "عمرو دياب", profession: "مطرب", knownFor: "مطرب مصري شهير يُلقب بالهضبة، حقق مبيعات قياسية في الوطن العربي، أشهر ألبوماته: تملي معاك، نور العين." },
      { name: "Youssef Chahine", nameAr: "يوسف شاهين", profession: "مخرج", knownFor: "مخرج سينمائي مصري عالمي، رائد السينما العربية. أخرج أفلاماً خالدة مثل باب الحديد والأرض والمصير." },
      { name: "Adel Imam", nameAr: "عادل إمام", profession: "ممثل", knownFor: "ممثل مصري كبير، أحد أبرز نجوم الكوميديا والدراما في الوطن العربي على مدى 50 عاماً." },
      { name: "Om Kalthoum", nameAr: "أم كلثوم", profession: "مطربة", knownFor: "كوكب الشرق، أعظم مطربة في تاريخ الموسيقى العربية. صاحبة صوت خالد عبر الأجيال." },
      { name: "Naguib Mahfouz", nameAr: "نجيب محفوظ", profession: "أديب", knownFor: "أديب مصري حائز على جائزة نوبل في الأدب 1988. صاحب الثلاثية وأولاد حارتنا." },
      { name: "Moez Masoud", nameAr: "معز مسعود", profession: "طبيب بيطري", knownFor: "طالب طب بيطري مصري اشتهر بفطنته وسرعة بديهته في برنامج المسابقات." },
      { name: "Ahmed Zewail", nameAr: "أحمد زويل", profession: "عالم", knownFor: "عالم مصري حائز على جائزة نوبل في الكيمياء 1999 لاختراعه ميكروسكوب الفيمتو." },
      { name: "Mohamed ElBaradei", nameAr: "محمد البرادعي", profession: "سياسي", knownFor: "مدير الوكالة الدولية للطاقة الذرية الأسبق، حائز على جائزة نوبل للسلام 2005." },
      { name: "Hani Shaker", nameAr: "هاني شاكر", profession: "مطرب", knownFor: "مطرب مصري كبير، نقيب الموسيقيين المصريين، أحد أعمدة الموسيقى العربية." },
      { name: "Mohamed Abdo", nameAr: "محمد عبده", profession: "مطرب", knownFor: "فنان سعودي-مصري، أحد أشهر مطربي الوطن العربي على مدى 4 عقود." },
      { name: "Faten Hamama", nameAr: "فاتن حمامة", profession: "ممثلة", knownFor: "سيدة الشاشة العربية، أيقونة السينما المصرية والعربية على مدار 50 عاماً." },
      { name: "Salah Zulfikar", nameAr: "صلاح ذو الفقار", profession: "ممثل", knownFor: "نجم السينما المصرية في الستينيات والسبعينيات، أحد أبرز وجوه الفن المصري." },
    ],
    previousLeaders: [
      { name: "Muhammad Ali Pasha", nameAr: "محمد علي باشا", title: "والي", from: "1805", to: "1848" },
      { name: "Khedive Ismail", nameAr: "الخديوي إسماعيل", title: "خديوي", from: "1863", to: "1879" },
      { name: "Saad Zaghloul", nameAr: "سعد زغلول", title: "زعيم الأمة - رئيس وزراء", from: "1924", to: "1924" },
      { name: "King Fuad I", nameAr: "الملك فؤاد الأول", title: "ملك", from: "1922", to: "1936" },
      { name: "King Farouk", nameAr: "الملك فاروق", title: "ملك", from: "1936", to: "1952" },
    ...
    leaderChildren: ['محمود السيسي', 'حسن السيسي', 'أميرة السيسي', 'أسماء السيسي'],
  },
  iq: {
    landmarkDetails: [
